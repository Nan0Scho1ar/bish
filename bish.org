...
If you tell bish to fetch and load malicios code, it will load it.
With great power, comes great responsibility.
*** bish genes
Even bish's features aren't forced to be set in stone.
...
If you do implement a core feature you just cannot live without, consider submitting a pull request.
